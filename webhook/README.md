...
[Webhook](https://discord.com/developers/docs/resources/webhook) module of [disgo](https://github.com/sabafly/disgo)
...
```go
import "github.com/sabafly/disgo/webhook"
```
...
a full example can be found [here](https://github.com/sabafly/disgo/tree/master/_examples/webhook/example.go)